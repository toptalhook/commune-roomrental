        ...
        <div className="py-5">
            <div className="hidden sm:block py-10 border-y-[1px]" >
                ...
                <div className="flex items-center justify-center">
                    <Image src={"https://a0.muscache.com/im/pictures/airbnb-platform-assets/AirbnbPlatformAssets-GuestFavorite/original/78b7687c-5acf-4ef8-a5ea-eda732ae3b2f.png"} alt={""} width={90} height={160} />
                    <h1 className=" text-8xl font-bold py-10 mb-5 font-Circular" >{total.toFixed(2)}</h1>
                    <Image src={"   https://a0.muscache.com/im/pictures/airbnb-platform-assets/AirbnbPlatformAssets-GuestFavorite/original/b4005b30-79ff-4287-860c-67829ecd7412.png"} alt={""} width={90} height={160} />
                </div>
                <div className="flex flex-col justify-center items-center">

                    <h1 className="text-2xl font-bold">
                        {total > 4 ? 'Guest favorite' : 'Guest bad'}</h1>
                    <h1 className="px-10 py-2 text-[16px] mb-6">One of the most loved homes on Airbnb<br></br> based on ratings, reviews, and reliability</h1>
            ...
            {isOpen
                &&
                <Review closeModal={closeModal} listingId={listingId} />}
