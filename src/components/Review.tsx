        ...
        <div className="fixed z-50 inset-0 bg-gray-900 bg-opacity-60 w-full px-1 md:px-4">
            <div className="relative top-20 mx-auto shadow-xl rounded-md bg-white w-[95vw] mb-[10px]  md:w-[60vw] xl:top-50">
                ...
                <div className="flex items-center justify-center">
                    <Image src={"https://a0.muscache.com/im/pictures/airbnb-platform-assets/AirbnbPlatformAssets-GuestFavorite/original/78b7687c-5acf-4ef8-a5ea-eda732ae3b2f.png"} alt={""} width={60} height={100} className="w-[60px] h-[60px] md:w-[60px] md:h-[100px]" />
                    <h1 className=" text-4xl font-bold py-3  font-Circular md:text-5xl lg:py-10" >Your Review</h1>
                    <Image src={"   https://a0.muscache.com/im/pictures/airbnb-platform-assets/AirbnbPlatformAssets-GuestFavorite/original/b4005b30-79ff-4287-860c-67829ecd7412.png"} alt={""} width={60} height={100} className="w-[60px] h-[60px] md:w-[60px] md:h-[100px]" />
                </div>
